...
var game = (function () {
  ...
  var canvas,
    ...
    evilShots = 1,   // disparos que tiene el malo al principio
  ...
  function preloadImages () {
    for (var i = 1; i <= 8; i++) {
      ...
      evilImage.src = '../assets/images/malo' + i + 'x.png';
      evilImages.animation[i-1] = evilImage;
      var bossImage = new Image();
      bossImage.src = '../assets/images/jefe' + i + 'x.png';
      bossImages.animation[i-1] = bossImage;
    }
    evilImages.killed.src = '../assets/images/malo_muertox.png';
    bossImages.killed.src = '../assets/images/jefe_muertox.png';
    bgMain = new Image();
    bgMain.src = '../assets/images/fondovertical.png';
    bgBoss = new Image();
    bgBoss.src = '../assets/images/fondovertical.png';
    playerShotImage = new Image();
    playerShotImage.src = '../assets/images/disparo_bueno.png';
    evilShotImage = new Image();
    evilShotImage.src = '../assets/images/disparo_malo.png';
    playerKilledImage = new Image();
    playerKilledImage.src = '../assets/images/bueno_muertox.png';
  ...
  function showLifeAndScore () {
    ...
    bufferctx.fillText("Points: " + player.score, canvas.width - 100, 20);
    bufferctx.fillText("lives: " + player.life, canvas.width - 100,40);
  }
  ...
  function Player(life, score) {
    ...
    player = new Image();
    player.src = '../assets/images/buenox.png';
...
// Una prueba con salida en consola
        ...
        if(HaHechoClick === "CANVAS"){

          shoot();
        }


        if(HaHechoClick === "P" && player.posX < (canvas.width - player.width - 5)){
          for(var i= 1; i<=3; i++){
            if(HaHechoClick === "P" && player.posX < (canvas.width - player.width - 5)){
        ...
        if(HaHechoClick === "SPAN" && player.posX > 5  ){
          for(var i= 1; i<=3; i++){
            if(HaHechoClick === "SPAN"  && player.posX > 5){
              player.posX -= player.speed;
            }
  ...
  function showCongratulations () {
    ...
    bufferctx.fillText("CONGRATULATIONS", canvas.width / 2 - 100, canvas.height / 2 - 30);
    bufferctx.fillText("POINTS: " + player.score, canvas.width / 2 - 100, canvas.height / 2 );
